...
function makeSun( options ){
  ...
  // console.timeEnd("make sun solarflare");
	...
	sun.position.x = distance;

	// sun.setPositions = function(point)	{
	// 	this.starSurface.position.x = point.x;
	// 	this.starSurface.position.y = point.y;
	// 	this.starSurface.position.z = point.z;

	// 	this.starHalo.position.x = point.x;
	// 	this.starHalo.position.y = point.y;
	// 	this.starHalo.position.z = point.z;

	// 	this.starGlow.position.x = point.x;
	// 	this.starGlow.position.y = point.y;
	// 	this.starGlow.position.z = point.z;
	// }
